...
BOOST_FIXTURE_TEST_CASE( stake_unstake, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_to_self_with_transfer, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_while_pending_refund, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_negative, es_safecode_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, es_safecode_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_from_refund, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_to_another_user_not_from_refund, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
// Tests for voting
BOOST_FIXTURE_TEST_CASE( producer_register_unregister, es_safecode_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, es_safecode_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, es_safecode_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( more_than_30_producer_voting, es_safecode_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("13.0000"), core_sym::from_string("0.5791") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", core_sym::from_string("13.5791") ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, es_safecode_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, es_safecode_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, es_safecode_tester, * boost::unit_test::tolerance(1e+5) ) try {
   //alice1111111 becomes a producer
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, es_safecode_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE(producer_pay, es_safecode_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, es_safecode_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_votepay_share, es_safecode_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_invariant, es_safecode_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_proxy, es_safecode_tester, * boost::unit_test::tolerance(1e-5)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_update_order, es_safecode_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_transition, es_safecode_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_AUTO_TEST_CASE(votepay_transition2, * boost::unit_test::tolerance(1e-10)) try {
   es_safecode_tester t(es_safecode_tester::setup_level::minimal);
   ...
   t.set_abi(  config::system_account_name, contracts::util::system_abi_old().data() );
   {
      ...
      t.abi_ser.set_abi(abi, es_safecode_tester::abi_serializer_max_time);
   }
...
BOOST_FIXTURE_TEST_CASE(producers_upgrade_system_contract, es_safecode_tester) try {
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, es_safecode_tester) try {
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, es_safecode_tester, * boost::unit_test::tolerance(1e+6) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_both_proxy_and_producers, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( select_invalid_proxy, es_safecode_tester ) try {
   //accumulate proxied votes
   issue_and_transfer( "bob111111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("100.0002"), core_sym::from_string("50.0001") ) );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, es_safecode_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, es_safecode_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, es_safecode_tester ) try {
   create_accounts_with_resources( {  N(defproducer1), N(defproducer2), N(defproducer3) } );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer1", 1) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer2", 2) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer3", 3) );
...
BOOST_FIXTURE_TEST_CASE( buyname, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( bid_invalid_names, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( namebid_pending_winner, es_safecode_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_producers_in_and_out, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( setparams, es_safecode_tester ) try {
   //install multisig contract
   abi_serializer msig_abi_ser = initialize_multisig();
   auto producer_names = active_and_vote_producers();
...
BOOST_FIXTURE_TEST_CASE( setram_effect, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ram_inflation, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( eosioram_ramusage, es_safecode_tester ) try {
   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );
   transfer( "eosio", "alice1111111", core_sym::from_string("1000.0000"), "eosio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "eosio", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( ram_gift, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_auth, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_small_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( unstake_buy_rex, es_safecode_tester, * boost::unit_test::tolerance(1e-10) ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_rent_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_sell_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_claim_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_loans, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_loan_checks, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ramfee_namebid_to_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_maturity, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_savings, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( update_rex, es_safecode_tester, * boost::unit_test::tolerance(1e-10) ) try {
...
BOOST_FIXTURE_TEST_CASE( update_rex_vote, es_safecode_tester, * boost::unit_test::tolerance(1e-10) ) try {
...
BOOST_FIXTURE_TEST_CASE( deposit_rex_fund, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_lower_bound, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( close_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( set_rex, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( b1_vesting, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( setabi, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( change_limited_account_back_to_unlimited, es_safecode_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_pin_sell_ram, es_safecode_tester ) try {
   BOOST_REQUIRE( get_total_stake( "eosio" ).is_null() );
